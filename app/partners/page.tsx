...
export default function DonorsPartnersPage() {
  ...
  const handleSubmitRegistration = (e: React.FormEvent) => {
    e.preventDefault();
    setIsSubmitted(true);
    // Simulates an operational onboarding routing function
    setTimeout(() => {
      console.log("Onboarding Intake Payload Authorized:", {
        donorType,
        ...formData,
      });
    }, 400);
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        <option value="Bronze Partner" className="dark:bg-zinc-900">Bronze Supporter Tier</option>
                        <option value="Silver Partner" className="dark:bg-zinc-900">Silver Program Partner</option>
                        <option value="Gold Partner" className="dark:bg-zinc-900">Gold Institutional Patron</option>
                        <option value="In-kind Expert" className="dark:bg-zinc-900">In-Kind Service/Expertise Donor</option>
                      </select>
                    </div>
